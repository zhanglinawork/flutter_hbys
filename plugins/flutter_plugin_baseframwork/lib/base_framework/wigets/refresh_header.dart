...
class DefineHeaderWidget extends StatefulWidget {
  ...
  @override
  DefineHeaderWidgetState createState() => DefineHeaderWidgetState();
}

class DefineHeaderWidgetState extends State<DefineHeaderWidget>
    with TickerProviderStateMixin<DefineHeaderWidget> {
  // 是否到达触发刷新距离
  ...
  String get _refreshText {
    return widget.refreshHeader.refreshText ?? '下拉可以刷新';
  }

  String get _refreshReadyText {
    return widget.refreshHeader.refreshReadyText ?? '释放立即刷新';
  }

  String get _refreshingText {
    return widget.refreshHeader.refreshingText ?? '正在刷新...';
  }

  String get _refreshedText {
    return widget.refreshHeader.refreshedText ?? '刷新完成';
  }

  String get _refreshFailedText {
    return widget.refreshHeader.refreshFailedText ?? '刷新失败';
  }

  String get _noMoreText {
    return widget.refreshHeader.noMoreText ?? '没有更多';
  }

  String get _infoText {
    return widget.refreshHeader.infoText ?? '上次更新 %T';
  }
  ...
  String get _infoTextStr {
    ...
    String fillChar2 = _dateTime.day < 10 ? "0" : "";
    return _infoText.replaceAll(
        "%T", "${_dateTime.month}-$fillChar2${_dateTime.day} ${_dateTime.hour}:$fillChar${_dateTime.minute}");
  }
  ...
  @override
  void dispose() {
    debugPrint("refresh_header-------dispose()-------");
      ...
      children: <Widget>[
        Positioned(
          ...
          right: isVertical
              ...
              : null,
          child: Container(
            alignment: widget.refreshHeader.alignment ?? isVertical
                ? isReverse
                ? Alignment.topCenter
    ...
    return isVertical
      ...
      Expanded(
        ...
        child: Container(
            ...
            child: ImageHelper.HeaderloadingWidget()
        ),
      ),
      Expanded(
        flex: 3,
