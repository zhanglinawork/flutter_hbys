...
@MessageTag(value = "PromptMessage", flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
public class PromptMessage extends MessageContent {
    private final static String TAG = "PromptMessage";
    ...
    public byte[] encode() {
        ...
        try {
            io.flutter.Log.e("","jsonObj=="+jsonObj.toString().getBytes("UTF-8"));
    ...
    private String getEmotion(String content) {
        io.flutter.Log.e("","content"+content);
        ...
        io.flutter.Log.e("","content222"+sb.toString());
        return sb.toString();
    }
    ...
    public static PromptMessage obtain(String text) {
        PromptMessage model = new PromptMessage();
        model.setContent(text);
        return model;
    }

    public PromptMessage(byte[] data) {
        String jsonStr = null;
        try {
     ...
     */
    public PromptMessage(Parcel in) {
     ...
     */
    public static final Creator<PromptMessage> CREATOR = new Creator<PromptMessage>() {

        @Override
        public PromptMessage createFromParcel(Parcel source) {
            return new PromptMessage(source);
        }

        @Override
        public PromptMessage[] newArray(int size) {
            return new PromptMessage[size];
        }
    };
